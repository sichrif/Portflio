...
export default function Floating() {
  ...
  return (
    <web.main style={{ background: props.open.to([0, 1], ['#faa0', '#faa0']) }}>
      {/* <web.h1 style={{fontSize:"27px",paddingTop:"12%",textAlign:"center",marginLeft:"50%",opacity: props.open.to([0, 1], [1, 0]), transform: props.open.to((o) => `translate3d(-50%,${o * 50 - 100}px,0)`) }}>
        Open me
      </web.h1> */}
      <Canvas style={{height:"500px"}} dpr={[1, 2]} camera={{ position: [0, 0, 0], fov: 35 }}>
